================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : BoxLooker CE Project Overview
===============================================================================

The application wizard has created this BoxLooker CE application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your BoxLooker CE application.
...
BoxLooker CE.h
    ...
    project specific headers and declares the CBoxLookerCEApp application class.

BoxLooker CE.cpp
    This is the main application source file that contains the application
    class CBoxLookerCEApp.
...
res\BoxLookerCEppc.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.


res\BoxLooker CE.ico
...
StdAfx.h, StdAfx.cpp
    ...
    named BoxLooker CE.pch and a precompiled types file named StdAfx.obj.
